"""
Rebecca Clause  — Understand any contract clause in plain English
...
DB_FILE      = "rebecca_clause.db"
SYSTEM_PROMPT = "You are an expert Rebecca Clause  assistant. Paste a contract clause and get a plain-English explanation of what it means, what risks it carries, and what to watch out for."

app = FastAPI(title="Rebecca Clause ")
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Rebecca Clause </div>
    <div class="auth-sub">Understand any contract clause in plain English</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Rebecca Clause </div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Rebecca Clause </em><br>Understand any contract clause in plain English</h1>
    <p>Paste a contract clause and get a plain-English explanation of what it means, what risks it carries, and what to watch out for. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <button class="card-action" onclick="clearForm()">Clear</button>
        ...
        <div class="field">
      <label for="field-contract_clause_text">Contract Clause Text</label>
      <textarea id="field-contract_clause_text" placeholder="Enter contract clause text..." required></textarea>
    </div>
    <div class="field">
      <label for="field-contract_type">Contract Type</label>
      <select id="field-contract_type">
    ...
    <div class="field">
      <label for="field-your_role">Your Role</label>
      <select id="field-your_role">
        <option value="">— Select —</option>
  ...
  <footer>
    <div class="foot-note">Rebecca Clause  &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Rebecca Clause  assistant. Paste a contract clause and get a plain-English explanation of what it means, what risks it carries, and what to watch out for.",
  promptTemplate: "Contract Clause Text: {{contract_clause_text}}\\nContract Type: {{contract_type}}\\nYour Role: {{your_role}}",
  resultFormat:   'steps', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "contract_clause_text", "label": "Contract Clause Text", "type": "textarea", "placeholder": "Enter contract clause text...", "required": true}, {"id": "contract_type", "label": "Contract Type", "type": "select", "options": ["Employment", "SaaS / Software", "Service agreement", "NDA", "Other"], "required": false}, {"id": "your_role", "label": "Your Role", "type": "select", "options": ["Founder", "Manager", "Individual contributor", "Executive"], "required": false}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Rebecca Clause ", "ai_ready": bool(GROQ_API_KEY)}
